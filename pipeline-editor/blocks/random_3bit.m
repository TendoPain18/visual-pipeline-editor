function random_3bit(pipeOut)
% RANDOM_3BIT - Generates random 3-bit numbers with protocol
%
% @BlockConfig
% name: Random3Bit
% inputs: 0
...
% maxValue: 7
% totalDataGB: 5
% description: Generates random 3-bit numbers (0-7)
% @EndBlockConfig
