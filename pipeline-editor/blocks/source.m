function source(pipeOut)
% SOURCE - Data source block with protocol
%
% @BlockConfig
% name: Source
% inputs: 0
...
% @EndBlockConfig
    ...
    fprintf('========================================\n');
    fprintf('SOURCE - Starting\n');
    fprintf('========================================\n');
    fprintf('Pipe Out:   %s\n', pipeOut);
    fprintf('Frame Size: %.2f MB\n', frameSize/1024/1024);
    fprintf('Mode:       %s\n', config.mode);
    fprintf('Total Data: %.1f GB\n', config.totalDataGB);
    fprintf('========================================\n\n');
    
    try
        fprintf('Generating random frame...\n');
        randomFrame = int8(randi([0 255], frameSize, 1) - 128);
        fprintf('Frame generated\n');
        ...
        for i = 1:totalFrames
            pipeline_mex('write', pipeOut, randomFrame);
            
            frameCount = frameCount + 1;
            totalBytes = totalBytes + frameSize;
        ...
        fprintf('\n\nSOURCE: Complete - %.2f GB transmitted\n', totalBytes/1e9);
